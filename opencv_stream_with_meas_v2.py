...
from stream_setup_v3 import RealSenseCamera
...
try:
    while True:
        ...
        if apply_filter:
            ...
            processed_depth_frame = camera.processed_depth_frame
        ...
        infrared_image = camera.frame_to_np_array(infrared_frame)

        ###########################################
        ##---------- IMAGE TO BE SHOWN ----------##
        ###########################################
        image_to_be_shown = processed_depth_image
