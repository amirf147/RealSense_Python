...
try:
    while True:
        ...
        if apply_filter:
            ...
            filtered_depth_frame = camera.filtered_frameset.get_depth_frame()
        ...
        proc_depth_image = camera.frame_to_np_array(filtered_depth_frame, colorize_depth=True)

        depth_image = camera.frame_to_np_array(depth_frame, colorize_depth=True)

        img = proc_depth_image
